        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <span className="section-kicker">
              {getContentText(content, "about.subtitle", language)}
            </span>
            <h2 className="text-3xl md:text-5xl font-semibold mt-4 mb-4 tracking-tight">
              {getContentText(content, "about.title", language)}
            </h2>
          ...
          <div className="grid md:grid-cols-5 gap-8 items-start">
            <div className="md:col-span-3 space-y-6">
              <p className="text-lg text-foreground-secondary leading-relaxed bg-card/70 border border-border/70 rounded-3xl p-6">
                {getContentText(content, "about.p1", language)}
              </p>
              
              <p className="text-lg text-foreground-secondary leading-relaxed bg-card/70 border border-border/70 rounded-3xl p-6">
                {getContentText(content, "about.p2", language)}
              </p>

              <p className="text-lg text-foreground-secondary leading-relaxed bg-card/70 border border-border/70 rounded-3xl p-6">
                {getContentText(content, "about.p3", language)}
              </p>
              ...
              <div className="pt-6 grid grid-cols-2 gap-4">
                <div className="p-5 rounded-2xl bg-card border border-border/70 hover-card">
                  ...
                  <div className="text-sm text-foreground-muted">
                    {getContentText(content, "about.yearsOfProgramming", language)}
                  </div>
                </div>
                <div className="p-5 rounded-2xl bg-card border border-border/70 hover-card">
                  <div className="text-2xl font-bold text-accent">
                  ...
                  <div className="text-sm text-foreground-muted">
                    {getContentText(content, "about.projectsDeveloped", language)}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="md:col-span-2 space-y-4">
              <div className="p-6 rounded-3xl bg-card border border-border/70 hover-card">
                <h3 className="font-semibold mb-4 flex items-center gap-2">
                  ...
                  {getContentText(content, "about.location", language)}
                </h3>
                <p className="text-foreground-secondary">
                  {localizeText(language, profile.locationPt, profile.locationEn)}
                </p>
              </div>
              ...
              <div className="p-6 rounded-3xl bg-card border border-border/70 hover-card">
                <h3 className="font-semibold mb-4 flex items-center gap-2">
                  ...
                  {getContentText(content, "about.languages", language)}
                </h3>
                <div className="space-y-2">
                  {spokenLanguages.map((spokenLanguage) => (
                    <div key={spokenLanguage.id} className="flex justify-between items-center">
                      <span className="text-foreground-secondary">
                        {localizeText(language, spokenLanguage.namePt, spokenLanguage.nameEn)}
                      </span>
                      <span className="text-accent text-sm font-medium">
                        {localizeText(language, spokenLanguage.levelPt, spokenLanguage.levelEn)}
                      </span>
                    </div>
                  ))}
                </div>
              ...
              <div className="p-6 rounded-3xl bg-card border border-border/70 hover-card">
                <h3 className="font-semibold mb-4 flex items-center gap-2">
                  ...
                  {getContentText(content, "about.education", language)}
                </h3>
                <p className="text-foreground-secondary">
